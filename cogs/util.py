...
def calculateTreasure(level, charcp, seconds, guildDouble=False, playerDouble=False, dmDouble=False):
...
"""
async def callAPI(ctx, apiEmbed, apiEmbedmsg, table, query=None, tier=5, exact=False, filter_rit=True):
